...
import joseph from '../Assets/images/ksjoseph.png'
import varghesephilip from '../Assets/images/varghesephilip.png'
    ...
    return (
        <>
            <div className='aboutUsContainer'>
                ...
                <div className='aboutUsContent'>
                    <div className='aboutTextContent'>
                        <h3 className=''>From the President of IPCKS</h3>
                        <p>
                            Our Lord Jesus Christ, commanded us to go around the world,
                            preach the Good News, make disciples, and teach them all that
                            He has commanded. A Christian's Primary responsibility in this
                            perverse and wicked generation is to share the Good News of
                            Jesus Christ with the perishing multitudes. Those who receive the
                            Word turn their hearts to Jesus and become disciples.
                            <br></br>
                            The Karnataka Bible College aims at obeying the <b>Great Commission of our Lord.</b>
                            In the present age, where heresies and false teachings are sometimes indistinguishable,
                            we equip the young dedicated workers of the Lord to biblically align their ministry
                            and reach out to th masses.
                            <br></br>
                            <br></br>
                            <br></br>
                            <br></br>
                            <b>Pr.K S Joseph</b>
                            <br></br>
                            State President, IPC Karnataka State
                        </p>
                    </div>
                    <div className='photoContent'>
                        <img
                ...
                <div className='aboutUsContent'>
                    <div className='aboutTextContent'>
                        <h3 className=''>Words from the Registrar</h3>
                        <p>
                            Karnataka Bible College Stands for equipping saints to "correctly
                            handle the word of Truth" and for giving intensive training to
                            become "approved workers" (2 Tim 2:15). We strongly believe that
                            <b>Bible is supreme authority and is God's revelation in history.</b>
                            It is inspired, inerrant and infallible. There is no higher authority
                            than the Word of God and its authority is timeless and unchanging inspite of all
                            the philosophical and theological transitions taking place in this generation.
                            We acknowledge its power to mould the conscience, conviction and character of those
                            who devote for learning. Also, we affirm that is has the authority to transform all
                            the cultural practices and traditions tainted with evil and impure influence.
                            <br></br>
                            <br></br>
                            KBC has been in an upward path for the last 30 years, and dedicated
                            for equipping young people to bring God's rule on earth through various
                            ministries and missions. Thank God for those who have invested time, talents,
                            and treasures for the growth and development of the institution. We continue the visionaryof the poineers
                            to equip soldiers, stewards and servents for the Kingdom purpose and invite well wishers and visionaries to become
                            partners to fulfil the Great Commission.
                            <br></br>
                            <br></br>
                            <b>Dr. Varughese Philip, Ph.D</b>
                            <br></br>
                            Registrar
                        </p>
                    </div>
